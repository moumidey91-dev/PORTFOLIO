      ...
      <div className="hero-container">
        ...
        <div className="hero-graphic-container">
          ...
          <div className="hero-avatar-wrapper animate-float">
            ...
            {/* 2. Data Analysis Card */}
            <div className="floating-card card-data-analysis">
              <div className="card-header-mini">Data Analysis</div>
            ...
            <div className="floating-card card-react">
              <svg viewBox="-11.5 -10.23174 23 20.46348" width="28" height="28" className="react-logo-svg">
            ...
            {/* 6. Research Card */}
            <div className="floating-card card-research">
              <div className="research-content-wrapper">
                ...
                <div className="research-text-lines">
                  <div className="research-line short"></div>
